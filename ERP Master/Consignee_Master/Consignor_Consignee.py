        ...
        for index, row in df.iterrows():
            try:
                ...
                if self.Helper.switch_frames("RegistrationHeadId"):
                    self.Helper.select_dropdown(By.ID, "RegistrationHeadId", row["RegistrationHead"])
                ...
                if self.Helper.switch_frames("StateId"):
                    ...
                    self.Helper.select_dropdown(By.ID, "BusinessVerticalId", row["BusinessVertical"])
                    self.Helper.send_keys(By.ID, "GSTNumber", str(row["GSTNumber"]))
                    self.Helper.click_element(By.ID, "btnSave-CustGSTRegistrationSession748")
