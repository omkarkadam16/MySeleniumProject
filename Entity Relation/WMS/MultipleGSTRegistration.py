...
class EntityRelation(unittest.TestCase):
    ...
    def test_master(self):
        ...
        for links in ["Administration",
            ...
            series = [
                {"Property": "StateId", "Column": "StateName", "Entity": "State",
                 "Key": "Uid", "Display": "StateName"},

                {"Property": "BusinessVerticalId", "Column": "BusinessVertical", "Entity": "CommonMaster",
                 "Key": "Uid", "Display": "MasterName"},

                {"Property": "GSTNumber", "Column": "GSTNumber", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "EmailId", "Column": "Email", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "MobNo", "Column": "MobileNumber", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "AdditionalKey", "Column": "AdditionalKey", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "ContactPerson", "Column": "ContactPerson", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "EffectiveFrom", "Column": "EffectiveFrom", "Entity": "None",
                 "Key": "None", "Display": "None"},

                {"Property": "TransactionId", "Column": "PartyName", "Entity": "Party",
                 "Key": "Uid", "Display": "PartyName"},

                {"Property": "ReferenceLinkId", "Column": "ReferenceLinkId", "Entity": "None",
                 "Key": "None", "Display": "None"},
            ...
            if self.switch_frames("LinkId-select"):
                ...
                suggestion = wait.until(EC.visibility_of_element_located(
                    (By.XPATH, "//ul[@id='ui-id-2']//li//a[text()='Multiple GSTRegistration Value']")))
                ...
                if self.switch_frames("AsmQualifiedName"):
                    self.send_keys(By.ID, "AsmQualifiedName","RSuite.Domain.Common.Registration.GSTRegistration,RSuite.Domain.Common")
