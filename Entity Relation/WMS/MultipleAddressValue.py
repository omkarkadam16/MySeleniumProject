...
class EntityRelation(unittest.TestCase):
    ...
    def test_master(self):
        ...
        for links in ["Administration",
            ...
            series = [
                {"Property": "AddressTypeId", "Column": "AddressType", "Entity": "AddressType",
                 "Key": "Uid", "Display": "AddressTypeName"},
                {"Property": "AddressLine", "Column": "AddressLine", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "CityId", "Column": "City", "Entity": "City",
                 "Key": "Uid", "Display": "CityName"},
                {"Property": "PinCode", "Column": "PinCode", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "ContactNo", "Column": "ContactNos", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "Fax", "Column": "FaxNo", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "Mob", "Column": "Mobile", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "ReferenceLinkId", "Column": "LinkId", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "TransactionId", "Column": "PartyName", "Entity": "Party",
                 "Key": "Uid", "Display": "PartyName"},
                {"Property": "AdditionalKey", "Column": "AdditionalKey", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "StdCode", "Column": "StdCode", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "Email", "Column": "Email", "Entity": "None",
                 "Key": "None", "Display": "None"},
                {"Property": "Code", "Column": "Code", "Entity": "None",
                 "Key": "None", "Display": "None"}
            ]
            ...
            if self.switch_frames("LinkId-select"):
                ...
                suggestion = wait.until(EC.visibility_of_element_located(
                    (By.XPATH, "//ul[@id='ui-id-1']//li//a[text()='Multiple Address Value']")))
                ...
                if self.switch_frames("AsmQualifiedName"):
                    self.send_keys(By.ID, "AsmQualifiedName","RSuite.Domain.Common.Geography.AddressValue,RSuite.Domain.Common")
